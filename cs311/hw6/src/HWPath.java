...
public class HWPath {
	public static void main(String[] args)  throws Exception {
		...
		for (int i=0; i < n; i++)
			System.out.printf("%5s", pQ.extractMin());
		System.out.println();

		System.out.println("Updated Sorted Order");
		pQ.add(1, 5);
		pQ.add(11, 6);
		pQ.add(2, 6);
		pQ.add(3, 4);
		...
		System.out.println("Path from 1 to 8 using some different valuations of relaxation parameters");
