...
public interface Vertex extends Visitable {
     ...
     */
    Collection<edu.iastate.cs228.hw5.Edge> edges();
     ...
     * @throws IndexOutOfBoundsException if one occurs (e.g. the array is of insufficient length)
     */
     ...
     * vertex.
     */
    @Override void setVisited(boolean visited);
}
